...
const ApiManagement = ({ url, token }) => {
  // Sempre usar o token de Super Admin quando disponível
  ...
  const saveSpecificApiSettings = async (apiType) => {
    try {
      ...
      // Usar rota geral para salvar configurações das APIs suportadas
  ...
  // Removido: testes do Telegram não são mais suportados

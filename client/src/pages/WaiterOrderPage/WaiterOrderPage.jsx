...
const WaiterOrderPage = () => {
  ...
  // Em desenvolvimento, use proxy do Vite com paths relativos; em produção, VITE_BACKEND_URL
  ...
  useEffect(() => {
    // Atualiza o título da aba para a identidade Zappy
    if (document.title !== 'Garçom Zappy!') {
      document.title = 'Garçom Zappy!';
    }
